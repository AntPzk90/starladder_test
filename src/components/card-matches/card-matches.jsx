...
class CardMatches extends React.Component {
  ...
  render() {
    return (
      <li
        className={`card ${
          this.props.card.active ? "card--active" : ""
      ...
      >
        ...
        <ul className="card__list card__list--titles">
          <li className="card__item">
            <h3 className="card__title">{this.props.card.firstTeam.title}</h3>
            <span className="card__coefficient">
              {this.props.card.firstTeam.coef}
            </span>
          </li>
          <li className="card__item">
            <h3 className="card__title">{this.props.card.secondTeam.title}</h3>
            <span className="card__coefficient">
        ...
        <div className="card__wrapper">
          <span className="card__system">
            <span
              ...
              style={{ display: !this.props.card.active ? "inline" : "none" }}
            >
              Starts in: &#8194;
